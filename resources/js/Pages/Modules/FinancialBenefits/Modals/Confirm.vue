<template>
    <b-modal v-model="showModal" title="Confirm Release" style="--vz-modal-width: 600px;" hide-footer header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>    
