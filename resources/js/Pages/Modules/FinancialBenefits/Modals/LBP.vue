<template>
    <b-modal v-model="showModal" title="View LBP" style="--vz-modal-width: 590px;" hide-footer header-class="p-3 bg-light"
        class="v-modal-custom" modal-class="zoomIn" centered>
        ...
        <div class="code-view mt-4">
            <pre class="language-markup text-dark" style="height: 200px;"><code><code ref="t" v-for="(list,index) in info.lbp" v-bind:key="index">{{list.test}}<br/></code></code>
            </pre>
        </div>
    </b-modal>
</template>
